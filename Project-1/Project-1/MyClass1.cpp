...
string& MyClass1::ReffToElement(vector<string>& VectReff,int i)//вектор не в формате конст переменной поэтому можно изменить в обоих направлениях

{


    //возвращяем i-е значение вектора
    return VectReff[i];
...
void MyClass1::InventoryReferencer()
{
   ...
   //заполняю вектор Myinventiry 
    ...
    ///вызываю возвращяет нужный элемент вектора
    ...
    //для примера денлаю присваивание ссылки другой ссылке -ЭТО МАЛОЗАТРАТНАЯ ФУНКЦИЯ ПРИСВАИВАНИЯ
    ...
    //копирую строковый объект -ЭТО затратная ФУНКЦИЯ ПРИСВАИВАНИЯ
...
//////крестики нолики////////////////
/////////////////////Программа работы с нейронными сетями////////////////////
